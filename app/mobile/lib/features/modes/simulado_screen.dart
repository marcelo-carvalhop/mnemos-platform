            ...
            child: Center(
              child: Text(
                ...
                style: TextStyle(
                  ...
                  color: low ? MnemosColors.again : MnemosColors.primary,
                ),
              ),
            ),
          ),
              ...
              child: Center(
                child: Padding(
                  ...
                  child: Text(
                    ...
                    textAlign: TextAlign.center,
                    style:
                        const TextStyle(fontSize: 21, height: 1.4, color: MnemosColors.ink),
                  ),
                ),
              ),
            ),
          ...
          if (marked == seen.length && seen.isNotEmpty) ...[
            Text(
              ...
              style: const TextStyle(
                  fontSize: 34, fontWeight: FontWeight.w500, color: MnemosColors.primary),
            ),
            Text(
            ...
            Padding(
              ...
              child: Text(
                ...
                style: const TextStyle(fontSize: 13, color: MnemosColors.muted),
              ),
            ),
          for (final q in seen) ...[
            _MarkTile(
          ...
          Row(
            children: [
              Expanded(
                child: _MarkButton(
                  label: 'Errei',
                  colour: MnemosColors.again,
                  background: MnemosColors.againSurface,
              ...
              Expanded(
                child: _MarkButton(
                  label: 'Acertei',
                  colour: MnemosColors.good,
                  background: MnemosColors.goodSurface,
                  selected: value == true,
                  onTap: () => onMark(true),
                ),
              ),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Text(label,
            style: TextStyle(
                fontSize: 13,
                color: selected ? colour : MnemosColors.muted,
