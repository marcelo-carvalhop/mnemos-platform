        ...
        child: Column(
          ...
          children: [
            Text(
              ...
              style: const TextStyle(fontSize: 22, height: 1.35, color: AppColors.ink),
            ),
            if (revealed) ...[
              ...
              Text(
                back,
                textAlign: TextAlign.center,
                style: const TextStyle(fontSize: 17, height: 1.5, color: AppColors.muted),
              ),
            ] else ...[
...
class _GradeBar extends ConsumerWidget {
  ...
  static const _labels = {
    Grade.again: ('Errei', AppColors.again, AppColors.againBg),
    Grade.hard: ('Difícil', AppColors.hard, AppColors.hardBg),
    Grade.good: ('Bom', AppColors.good, AppColors.goodBg),
    Grade.easy: ('Fácil', AppColors.easy, AppColors.easyBg),
  };
      ...
      body: Center(
        child: Padding(
          ...
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              const Icon(Icons.landscape_outlined, size: 48, color: AppColors.navy),
